...
"use client"
import { Routes, Route, Navigate } from "react-router-dom"
// Remove direct imports for SignInPage and SignUpPage
// import SignInPage from "./pages/SignInPage"
// import SignUpPage from "./pages/SignUpPage"
import MePage from "./pages/MePage"
import ChatPage from "./pages/ChatPage"
import AuthLayout from "./pages/AuthLayout" // Import the new AuthLayout
import { useAuth } from "./lib/AuthContext"
  ...
  return (
    <Routes>
      ...
      <Route
        ...
        element={
          <PublicRoute>
            <AuthLayout /> {/* Use AuthLayout for both sign-in and sign-up */}
          </PublicRoute>
        }
      />
      <Route
